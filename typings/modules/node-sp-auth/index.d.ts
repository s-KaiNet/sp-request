...
declare module '~node-sp-auth~bluebird' {
...
// Generated by typings
// Source: node_modules/node-sp-auth/lib/src/auth/IAuthResponse.d.ts
declare module '~node-sp-auth/lib/src/auth/IAuthResponse' {
...
declare module 'node-sp-auth/lib/src/auth/IAuthResponse' {
export * from '~node-sp-auth/lib/src/auth/IAuthResponse';
}

// Generated by typings
// Source: node_modules/node-sp-auth/lib/src/auth/IAuthOptions.d.ts
declare module '~node-sp-auth/lib/src/auth/IAuthOptions' {
...
export type IAuthOptions = IOnlineAddinCredentials | IOnPremiseAddinCredentials | IUserCredentials | IOnpremiseUserCredentials | IAdfsUserCredentials;
...
declare module 'node-sp-auth/lib/src/auth/IAuthOptions' {
export * from '~node-sp-auth/lib/src/auth/IAuthOptions';
}

// Generated by typings
// Source: node_modules/node-sp-auth/lib/src/index.d.ts
declare module '~node-sp-auth/lib/src/index' {
import * as Promise from '~node-sp-auth~bluebird';
import { IAuthResponse } from '~node-sp-auth/lib/src/auth/IAuthResponse';
...
declare module 'node-sp-auth/lib/src/index' {
export * from '~node-sp-auth/lib/src/index';
}
declare module 'node-sp-auth' {
export * from '~node-sp-auth/lib/src/index';
}
